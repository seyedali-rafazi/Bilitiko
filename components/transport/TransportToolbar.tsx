...
import { buildDatePriceStrip, formatDateLabel, formatPriceShort } from '@/lib/transport-utils';
import { cn } from '@/lib/utils';

interface TransportToolbarProps extends TransportFiltersContentProps {
  sort: string;
...
export default function TransportToolbar({
  sort,
  onSortChange,
  basePrice,
  onDateSelect,
  ...
  return (
    <>
      ...
      <BottomSheet open={filterOpen} onClose={() => setFilterOpen(false)} title="فیلتر">
        <TransportFiltersContent {...filterProps} compact />
