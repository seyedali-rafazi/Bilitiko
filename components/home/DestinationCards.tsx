...
import { usePopularDestinations } from "@/hooks/queries";
...
export default function DestinationCards() {
  ...
  const { data: apiDestinations } = usePopularDestinations();
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
        {destinations.slice(0, 2).map((dest) => (
          <div
            ...
            onKeyDown={(e) =>
              e.key === "Enter" && openDestination(dest.destinationCode)
            }
            role="button"
            tabIndex={0}
          >
        ...
        <div
          ...
          onKeyDown={(e) =>
            e.key === "Enter" &&
            openDestination(destinations[2].destinationCode)
          }
          role="button"
          tabIndex={0}
        >
