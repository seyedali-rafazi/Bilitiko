            ...
            <Card padding="lg">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <a href="tel:0214045" className="text-neutral-gray6 hover:text-primary-blue">021-4045</a>
                </div>
              </div>
            </Card>
            <Card padding="lg">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <a href="mailto:support@bilito.ir" className="text-neutral-gray6 hover:text-primary-blue">support@bilito.ir</a>
                </div>
              </div>
            </Card>
            <Card padding="lg">
