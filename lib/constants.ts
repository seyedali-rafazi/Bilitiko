...
export const FAQS: FAQ[] = [
  {
    ...
    answer: 'بلیط تمام خطوط هوایی دنیا در سایت بیلیتو موجود است، چه پروازهایی که مبدا یا مقصد آنها ایران است و چه پروازهای داخلی دورترین کشورهای دنیا.',
  },
  {
  ...
  {
    question: 'بلیط پرواز چه کشورها ایرلاین‌هایی را می‌توانم‌ در سایت بیلیتو جستجو و خریداری کنم؟',
    answer: 'تمام ایرلاین‌های داخلی و بین‌المللی در بیلیتو قابل جستجو و خرید هستند.',
  },
];
